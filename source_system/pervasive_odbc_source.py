...
# TODO: confirm exact DSN name from ODBC Data Source Administrator once
# a Pervasive Client DSN (not just the server engine registration) exists
# for this database.
DSN_NAME = "TODO_TUTOR_DSN"
